    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
            <div class="flex items-center justify-between">
                <div class="text-lg font-medium text-gray-700">Total Products</div>
            ...
            <div class="mt-4 text-3xl font-semibold text-gray-900">{{ $productCount }}</div>
        </div>

        <!-- Categories Card -->
        <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200">
            <div class="flex items-center justify-between">
                <div class="text-lg font-medium text-gray-700">Total Categories</div>
            ...
            <div class="mt-4 text-3xl font-semibold text-gray-900">{{ $categoryCount }}</div>
        </div>
    </div>
</div>
@endsection
